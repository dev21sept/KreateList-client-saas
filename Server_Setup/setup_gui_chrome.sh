#!/bin/bash
# ==============================================================================
#                      GUI, REMOTE DESKTOP (RDP) & CHROME SETUP SCRIPT
# ==============================================================================
# Installs XFCE (lightweight GUI), XRDP, and Google Chrome on Ubuntu,
# then configures users 'ubuntu', 'dpatidar200214', and 'user' with password '1234'.
# ==============================================================================
...
echo "=== 5b. Configuring User: user ==="
# Only set up user if it exists on the system
if id -u user >/dev/null 2>&1; then
    echo "user:1234" | sudo chpasswd
    echo "User user password set to 1234."
    if [ -d /home/user ]; then
        echo "xfce4-session" | sudo tee /home/user/.xsession > /dev/null
        sudo chown user:user /home/user/.xsession
    fi
else
    echo "User 'user' does not exist on this machine. Skipping."
fi
...
echo "=== 8. Installing Google Chrome ==="
...
# Install downloaded package using apt to resolve dependencies
...
echo "   - Username: user (or dpatidar200214)"
echo "   - Password: 1234"
echo "============================================================"
