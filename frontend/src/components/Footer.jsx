      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-500">
              <li className="flex items-center text-xs"><Mail size={14} className="mr-2" /> support@elister.ai</li>
        ...
        <div className="pt-8 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center text-xs text-slate-400 space-y-4 md:space-y-0">
          <p>© 2026 <a href='https://www.elister.ai/'>Elister.ai</a> By Kreatelist Infotech Private Limited. All rights reserved.</p>
