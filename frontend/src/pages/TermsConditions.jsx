      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm p-8 md:p-12">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            <p>
              These terms and conditions are a type of contract between You (As User) and <strong>Elister By Kreatelist Infotech Private Limited</strong> (Service Provider Company) to access the Website or Web Application or Mobile Application (Android and IOS Both) of Elister By Kreatelist Infotech Private Limited.
            </p>
            ...
            <ul className="list-disc pl-5 space-y-6">
              ...
              <li>
                <span className="font-semibold text-gray-900">6. Intellectual Property:</span> I will not use, copy, reverse engineer, or replicate the same business idea, features (like Rule Engine, AI Optimizer, Taxonomy API), or software logic of Elister By Kreatelist Infotech Private Limited at any point.
              </li>
            </ul>
